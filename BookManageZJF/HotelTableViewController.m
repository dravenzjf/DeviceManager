...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Book *hotel = [self.hotelList objectAtIndex:curRow];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if([[segue identifier]isEqualToString:@"ShowHotelDetail"]){
        ...
        Book *curHotel = [self.hotelList objectAtIndex:ip.row];
        BookViewController *hotelDetailVC = [segue destinationViewController];
        //将这个hotel指针传过去
